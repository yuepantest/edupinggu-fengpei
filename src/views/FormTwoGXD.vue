<template>
  <div>
    <div class="loading" v-if="loadFlag">
      <img class="loading-img" src="../assets/id_card_yxd.png" />
      <div class="progress_title">
        {{ $route.query.clientName }}
      </div>
      <div class="progress_title">正在对你的信息进行评估...</div>
      <van-loading
        ...
        vertical
      ></van-loading>
      <div class="progress_bottom">预估需要3分钟，请耐心等待...</div>
    </div>
    <div v-if="!loadFlag">
      <div class="top_back">
