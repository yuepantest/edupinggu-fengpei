<template>
  <div>
    <div class="top_back">
      <div class="text-img-text">快享贷</div>
      ...
      <van-cell-group inset>
        <div class="top-line">
          <van-field
            ...
            :rules="[
              ...
              { validator: validatorNameTwo, message: '不能超过20个字' },
            ]"
          ></van-field>
        </div>
        ...
        <van-field
          ...
          :rules="[
            ...
            { validator: validatorMount, message: '金额应大于5000，小于500万' },
          ]"
        />
      </van-cell-group>
    ...
    <div class="buttom-title">
      声明:本平台只根据用户提交的信息进行资信额度评估，不会涉及到用户隐私和征信查询，请放心使用。具体放款根据金融机构审核为准。
    </div>
  </div>
</template>
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      validatorNameOne,
      validatorNameTwo,
      patternPhone: /^[1][3,4,5,6,7,8,9][0-9]{9}$/,
      patternIdentity:
